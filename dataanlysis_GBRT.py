...
def mul_lr():
    ...
    print('X_train.shape={}\n y_train.shape ={}\n X_test.shape={}\n,  y_test.shape={}'.format(X_train.shape,
                                                                                              ...
                                                                                              X_test.shape,
                                                                                              y_test.shape))
    # linreg= ensemble.RandomForestRegressor(n_estimators=100)#这里使用20个决策树
    # linreg = ensemble.GradientBoostingRegressor(n_estimators=100)
    linreg = ensemble.AdaBoostRegressor(n_estimators=100)
